...
require_pattern 'SMART_HOME_FIRMWARE_VERSION "2\.8\.0-responsive-local"' "$firmware"
...
require_pattern "platform :ios, '16\.4'" "$project_root/ios/Podfile"
require_pattern "IPHONEOS_DEPLOYMENT_TARGET.*16\.4" "$podfile"
require_pattern 'IPHONEOS_DEPLOYMENT_TARGET = 16\.4' "$ios_project"
require_pattern '<string>16\.4</string>' "$ios_framework_info"
